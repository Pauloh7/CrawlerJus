        ...
        if "consultaProcesso" in url:
            return json.dumps({
                "data": [{
                    ...
                    "partes": {"parte": [{"descricaoTipo": "EXEQUENTE", "nome": "UNIFERTIL - UNIVERSAL DE FERTILIZANTES S/A"}]}
                }]
            })
        return json.dumps({"data": [{"data": "23/01/2026", "descricao": "Expedida/certificada a intimação eletrônica"}]})
